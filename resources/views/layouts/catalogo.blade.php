...
<html lang="en">
	...
	<head>
		...
		<title>Motorcycle Shop Grid - Neoncart HTML5 Template</title>
				...
				<div class="container maxw_1430">
					<div class="motorcycle_deals_carousel2 position-relative text-white">
						<div class="slideshow1_slider clearfix" data-slick='{"dots": false}'>
							<div class="item has_overlay" data-background="images/backgrounds/bg_30.jpg">
							...
							<div class="item has_overlay" data-background="images/backgrounds/bg_30.jpg">
								...
								<div class="container maxw_1430">
									<div class="row align-items-center justify-content-lg-between">
										<div class="col-lg-5">
											<div class="item_image text-center">
												<img src="images/deals/motorcycle/img_02.png" alt="image_not_found">
											</div>
										</div>
								...
								<div class="sb_widget sb_recent_post">
									...
									<div class="carparts_small_blog">
										<a class="item_image" href="blog_details.html">
											<img src="images/recent_post/img_06.png" alt="image_not_found">
										</a>
										<div class="item_content">
											<ul class="rating_star ul_li clearfix">
												<li><i class="fas fa-star"></i></li>
									...
									<div class="carparts_small_blog">
										<a class="item_image" href="blog_details.html">
											<img src="images/recent_post/img_07.png" alt="image_not_found">
										</a>
										<div class="item_content">
											<ul class="rating_star ul_li clearfix">
												<li><i class="fas fa-star"></i></li>
									...
									<div class="carparts_small_blog">
										<a class="item_image" href="blog_details.html">
											<img src="images/recent_post/img_08.jpg" alt="image_not_found">
										</a>
										<div class="item_content">
											<ul class="rating_star ul_li clearfix">
												<li><i class="fas fa-star"></i></li>
